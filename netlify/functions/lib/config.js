  ...
  eg: {
    ...
    dataBlocks: {
      ...
      landingCopy: {
        ...
        // "section" agrupa estos 16 campos bajo encabezados (ver
        // renderFieldsGrouped en el panel) — antes era una sola lista plana
        // y las fotos del comparador antes/después quedaban perdidas en el
        // medio, sin que se notaran entre el resto de textos.
        fields: [
          { key: 'sobreBio1', label: 'Párrafo 1', long: true, section: 'Sobre mí' },
          { key: 'sobreBio2', label: 'Párrafo 2', rich: true, previewTemplate: '<p class="eg-sobre__bio" id="eg-sobre-bio-2">__VALUE__</p>', section: 'Sobre mí' },
          { key: 'sobreBadgeNumero', label: 'Insignia (número/sigla)', section: 'Sobre mí' },
          { key: 'sobreBadgeTexto', label: 'Insignia (texto)', section: 'Sobre mí' },
          { key: 'sobreCredenciales', label: 'Credenciales (una por línea)', long: true, section: 'Sobre mí' },
          { key: 'cmpLabelAntes', label: 'Etiqueta "antes"', section: 'Comparador antes / después' },
          { key: 'cmpLabelDespues', label: 'Etiqueta "después"', section: 'Comparador antes / después' },
          { key: 'cmpHint', label: 'Texto de ayuda', section: 'Comparador antes / después' },
          { key: 'cmpImgAntes', label: 'Foto de "antes" (URL)', section: 'Comparador antes / después' },
          { key: 'cmpImgAntesAlt', label: 'Foto de "antes" (texto alternativo)', section: 'Comparador antes / después' },
          { key: 'cmpImgDespues', label: 'Foto de "después" (URL)', section: 'Comparador antes / después' },
          { key: 'cmpImgDespuesAlt', label: 'Foto de "después" (texto alternativo)', section: 'Comparador antes / después' },
          ...
          { key: 'ctaTitulo', label: 'Título', rich: true, previewTemplate: '<section id="cta" style="padding:32px 24px"><div class="eg-cta__inner"><h2 class="eg-cta__h2" id="eg-cta-h2">__VALUE__</h2></div></section>', section: 'Llamado a la acción final' },
          { key: 'ctaTexto', label: 'Texto', long: true, section: 'Llamado a la acción final' },
          { key: 'ctaMicro', label: 'Texto pequeño', section: 'Llamado a la acción final' },
          ...
          { key: 'footerCopyright', label: 'Línea de copyright', type: 'text-fixed-link', linkHref: '/privacidad', section: 'Pie de página' },
        ],
      },
      marcas: {
      ...
      preciosBase: {
        ...
        singleton: true,
        fields: [
          { key: 'sesionBasicoBase', label: 'Sesión Básico · precio a las 8 fotos', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'sesionBasicoIncremento', label: 'Sesión Básico · precio extra por cada foto (9-10 fotos)', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'sesionEstandarBase', label: 'Sesión Estándar · precio a las 10 fotos', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'sesionEstandarIncremento', label: 'Sesión Estándar · precio extra por cada foto (11-18 fotos)', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'sesionPremiumBase', label: 'Sesión Premium · precio a las 18 fotos', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'sesionPremiumIncremento', label: 'Sesión Premium · precio extra por cada foto (19+ fotos)', type: 'number', section: 'Sesión de fotos', compact: true },
          { key: 'planBasicoBase', label: 'Plan Básico · precio a las 12 fotos/mes', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'planBasicoIncremento', label: 'Plan Básico · precio extra por cada foto (13-14 fotos/mes)', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'planEstandarBase', label: 'Plan Estándar · precio a las 14 fotos/mes', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'planEstandarIncremento', label: 'Plan Estándar · precio extra por cada foto (15-20 fotos/mes)', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'planPremiumBase', label: 'Plan Premium · precio a las 20 fotos/mes', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'planPremiumIncremento', label: 'Plan Premium · precio extra por cada foto (21+ fotos/mes)', type: 'number', section: 'Plan mensual', compact: true },
          { key: 'descuento6meses', label: 'Descuento por pagar 6 meses de una vez (%)', type: 'number', section: 'Descuentos por prepago', compact: true },
          { key: 'descuento12meses', label: 'Descuento por pagar 12 meses de una vez (%)', type: 'number', section: 'Descuentos por prepago', compact: true },
        ],
      },
      preciosTextos: {
        ...
        singleton: true,
        fields: [
          { key: 'beneficioSesion1', label: 'Beneficio fijo 1', section: 'Sesión' },
          { key: 'beneficioSesion2', label: 'Beneficio fijo 2', section: 'Sesión' },
          { key: 'beneficioPlan1', label: 'Beneficio fijo 1', section: 'Plan mensual' },
          { key: 'beneficioPlan2', label: 'Beneficio fijo 2', section: 'Plan mensual' },
          { key: 'beneficioAsesoria', label: 'Beneficio extra desde 16 fotos/mes', section: 'Plan mensual' },
          { key: 'beneficioPaginaWeb', label: 'Beneficio extra desde 16 fotos/mes + 3 o más meses', section: 'Plan mensual' },
          { key: 'beneficioGuion', label: 'Beneficio extra si se agrega video (1 de 3)', section: 'Video adicional del plan' },
          { key: 'beneficioMusica', label: 'Beneficio extra si se agrega video (2 de 3)', section: 'Video adicional del plan' },
        ],
      },
      preciosExtras: {
